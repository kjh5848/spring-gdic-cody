...
public class AdminSaveBoardComponent extends BaseComponent {
    ...
    @FindBy(linkText = "공지사항")
    private WebElement noticeLink;

    @FindBy(linkText = "공지사항 등록")
    ...
    public AdminSaveBoardComponent(WebDriverWait wait, WebDriver driver) {
        this.wait = wait;
    ...
    public void noticeClick(){
        ...
        for (int i = 0; i < 10; i++) {
            this.noticeLink.sendKeys(Keys.RIGHT);
        }
        Uninterruptibles.sleepUninterruptibly(2, TimeUnit.SECONDS);
